...
router.put('/linkxidbanner/:idbanner', _auth.verifyAdmin, _banners.default.editarURL);
router.delete('/linkxidbanner/:idbanner', _auth.verifyAdmin, _banners.default.eliminarURL);
